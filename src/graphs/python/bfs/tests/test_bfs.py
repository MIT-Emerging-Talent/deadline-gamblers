...
class TestBFS(unittest.TestCase):
    ...
    def test_bfs_int_vertices_positive(self):
        ...
        self.assertEqual(bfs(graph, Vertex(2), Vertex(0)), 2)
        self.assertEqual(bfs(graph, Vertex(2), Vertex(1)), 1)
        self.assertEqual(bfs(graph, Vertex(2), Vertex(2)), 0)
        self.assertEqual(bfs(graph, Vertex(2), Vertex(3)), 1)
